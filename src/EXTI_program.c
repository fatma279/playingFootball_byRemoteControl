...
/* Enable external interrupt on specific line */
void MEXTI_voidEnableEXTI(u8 Copy_u8Line)
{
	SET_BIT(EXTI -> IMR, Copy_u8Line);
}

/* Disable external interrupt on specific line */
void MEXTI_voidDisableEXTI(u8 Copy_u8Line)
{
	CLR_BIT(EXTI -> IMR, Copy_u8Line);
}

/* Enable software interrupt on speccific line */
void MEXTI_voidSoftWareTrigger(u8 Copy_u8Line)
{
	SET_BIT(EXTI -> SWIER, Copy_u8Line);
}

/* Initiat External interrupt in run time */
